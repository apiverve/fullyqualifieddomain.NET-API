...
namespace APIVerve
{
    public class FullyQualifiedDomainAPIClient
    {
        ...
        public FullyQualifiedDomainAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }

        public FullyQualifiedDomainAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public ResponseObj Execute(fullyqualifieddomainQueryOptions options)
        {
            try
            {
                if (_isDebug)
